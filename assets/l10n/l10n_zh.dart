...
class L10nZh extends L10n {
  ...
  @override
  String get appLockDescription => '用 pin 码在不用 Hermannpost 时锁定它';
  ...
  String inviteText(Object username, Object link) {
    return '$username 邀请你使用 Hermannpost。 \n1. 安装 Hermannpost：https://fluffychat.im \n2. 注册或登录 \n3. 打开邀请链接：\n $link';
  }
  ...
  @override
  String get newMessageInFluffyChat => '💬 Hermannpost 新消息';
  ...
  String get noGoogleServicesWarning =>
      '看起来你手机上没有 Firebase Cloud Messaging。如果仍希望接收 Hermannpost 的推送通知，推荐安装 ntfy。借助 ntfy 或另一个 Unified Push 程序，你可以以一种数据安全的方式接收推送通知。你可以从 PlayStore 或 F-Droid 商店下载 ntfy。';
  ...
  @override
  String get screenSharingDetail => '你正在 Hermannpost 中共享屏幕';
  ...
  @override
  String get callingAccountDetails => '允许 Hermannpost 使用本机 android 拨号器应用。';
  ...
  @override
  String get otherCallingPermissions => '麦克风、摄像头和其它 Hermannpost 权限';
  ...
  String get roomUpgradeDescription =>
      '聊天之后将以新的聊天室版本重新创建。所有参与者都会收到通知以切换到新的聊天室。有关聊天室版本的更多信息，请访问 https://spec.matrix.org/latest/rooms/';

  @override
  String get removeDevicesDescription => '你将注销此设备，无法再接收消息。';
  ...
  @override
  String get kickUserDescription => '该用户会被踢出聊天但未被封禁。在公开聊天中，该用户可以随时重新加入。';
  ...
  String get welcomeText =>
      '你好呀 👋 欢迎来到 Hermannpost。你可以登录任意兼容 https://matrix.org 的 homeserver，然后和任何人聊天。这是个巨大的去中心化消息网络！';
...
class L10nZhHant extends L10nZh {
  ...
  @override
  String inviteText(Object username, Object link) {
    return '$username 邀請您使用 Hermannpost\n1. 安裝 Hermannpost：https://fluffychat.im\n2. 登入或註冊\n3. 打開該邀請網址：\n$link';
  }
  ...
  @override
  String get newMessageInFluffyChat => '💬 來自 Hermannpost 的新訊息';
  ...
  @override
  String get noGoogleServicesWarning =>
      '您手機上沒有安裝 Google 服務框架。這或許對於保護您的隱私而言是個好事！但為了收到 Hermannpost 的推播通知，我們建議您使用 https://microg.org 或 https://unifiedpush.org。';
  ...
  @override
  String get callingAccountDetails => '允許 Hermannpost 使用原生 Android 撥號應用程式。';
  ...
  @override
  String get otherCallingPermissions => '麥克風、相機和其他 Hermannpost 權限';
