...
class L10nKo extends L10n {
  ...
  String get accessAndVisibilityDescription =>
      '채팅에 참여 할 수 있는 사람과 채팅을 볼 수 있는 범위';
  ...
  String inviteText(Object username, Object link) {
    return '$username님이 당신을 Hermannpost에 초대했습니다.\n1. Hermannpost 설치: https://fluffychat.im \n2. 가입하거나 로그인 \n3. 초대 링크 열기: \n $link';
  }
  ...
  @override
  String get newMessageInFluffyChat => '💬 Hermannpost에서 새로운 메시지';
  ...
  String get noGoogleServicesWarning =>
      '이 휴대폰에 Firebase Cloud Messaging 서비스가 없는 것 같습니다. Hermannpost에서 푸시 알림을 받으려면 ntfy 사용을 추천합니다. ntfy 혹은 다른 푸시 알림 제공자를 사용하면 알림을 보안적인 방법으로 받을 수 있습니다. ntfy는 PlayStore와 F-Droid에서 설치 가능합니다.';
  ...
  String get hideMemberChangesInPublicChatsBody =>
      '공개채팅에 누군가가 가입하거나 떠날때 타임라인에 표시하지 않습니다.';
  ...
  @override
  String get whoIsAllowedToJoinThisGroup => '누가 이 그룹 채팅에 들어오도록 허용할지';
  ...
  @override
  String get youJoinedTheChat => '채팅에 참여했습니다';
  ...
  @override
  String get noOneCanJoin => '아무도 들어올 수 없음';
  ...
  @override
  String get screenSharingDetail => 'Hermannpost에 당신의 화면을 공유하는중';
  ...
  String get callingAccountDetails =>
      'Hermannpost이 android 전화앱을 사용 할 수 있도록 허가.';
  ...
  String get appearOnTopDetails =>
      '앱이 상단에 표시되도록 허용 (이미 Hermannpost을 통화 계정으로 설정한 경우에는 필요하지 않음)';

  @override
  String get otherCallingPermissions => '마이크, 카메라 그리고 다름 Hermannpost 권한';
  ...
  String get noBackupWarning =>
      '경고! 채팅 백업을 켜지 않을경우, 당신은 암호화된 메시지에대한 접근권한을 잃을것입니다. 로그아웃 하기 전에 채팅을 백업하는것이 강력히 권장됩니다.';
  ...
  String get kickUserDescription =>
      '유저는 채팅에서 추방되지만 영구 추방되지 않습니다. 공개 채팅의 경우, 언제든 유저가 다시 들어올 수 있습니다.';
  ...
  String get chatPermissionsDescription =>
      '이 대화에서 특정 작업에 필요한 파워 레벨을 정의합니다. 파워 레벨 0, 50, 100은 일반적으로 사용자, 관리자, 관리자를 나타내지만, 모든 등급이 가능합니다.';
  ...
  String get homeserverDescription =>
      '모든 데이터는 이메일 제공자와 마찬가지로 Homeserver(이) 에 저장됩니다. 모든 사람과 여전히 소통할 수 있는 동안 사용하고 싶은 Homeserver(이) 를 선택할 수 있습니다. https://matrix.org에서 자세히 알아보세요.';

  @override
  String get doesNotSeemToBeAValidHomeserver =>
      '호환되는 Homeserver(이) 가 아닌 것 같습니다. URL이 올바르게 입력됐나요?';
  ...
  String get noticeChatBackupDeviceVerification =>
      '참고: 모든 기기를 대화 백업에 연결하면 자동으로 인증됩니다.';
  ...
  String get welcomeText =>
      '안녕하세요 👋 제 이름은 Hermannpost이에요. 당신은 Htpps://matrix.org에 호환되는 어떤 Homeserver에도 가입할 수 있어요. 그리고 아무나 대화하세요! 저는 큰 대화 네트워크랍니다! 😄';
